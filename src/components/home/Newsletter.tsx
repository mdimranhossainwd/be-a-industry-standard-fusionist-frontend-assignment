...
export default function Newsletter() {
  return (
    <section className="bg-[#f4f0e6] py-24 md:py-32 relative overflow-hidden">
      ...
      >
        ...
        <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold font-syne text-gray-900 leading-tight mb-6">
          ...
          <span className="text-primary-green relative">
            eco loop
            <svg className="absolute w-full h-4 -bottom-3 left-0 text-primary-green opacity-50" viewBox="0 0 200 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M2 9.5C35 3.5 100 -1.5 199 8.5" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeDasharray="8 8"/>
            </svg>
          </span>
        </h2>

        <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
          Get community highlights, top-rated ideas, and green funding alerts delivered securely once a week. Unsubscribe anytime.
        </p>

        <form className="max-w-md mx-auto relative flex items-center shadow-lg rounded-full overflow-hidden bg-white border border-gray-200">
          <input
            type="email"
          ...
          <Button 
            type="submit" 
            className="absolute right-2 top-2 bottom-2 bg-primary-green hover:bg-primary-green/90 text-white rounded-full px-6 text-sm font-semibold transition-transform hover:scale-105"
          >
