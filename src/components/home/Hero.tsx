      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl lg:text-[72px] font-bold font-syne leading-[1.1] text-gray-900">
            Ideas <br />
            that <span className="font-instrument italic text-primary-green font-normal">spark</span>{" "}
            real <br/>
            <span className="relative inline-block">
              change
              <svg className="absolute w-full h-3 -bottom-2 left-0 text-primary-green" viewBox="0 0 200 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.20399 9.38971C35.0931 3.25148 100.22 -1.41113 198.887 8.35859" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeDasharray="8 8"/>
              </svg>
            </span>
          </h1>
          ...
          <p className="text-gray-600 max-w-md text-lg leading-relaxed">
            A platform where eco-conscious minds share groundbreaking ideas. Join the movement to ignite sustainable change, fund solutions and inspire the world.
          </p>

          {/* Buttons */}
          <div className="flex flex-wrap items-center gap-4 pt-4">
            <Button className="bg-primary-green hover:bg-primary-green/90 text-white rounded-full px-8 py-6 text-base font-medium transition-transform hover:scale-105">
              Explore Ideas <ArrowRight className="ml-2 w-4 h-4" />
            </Button>
            <Button variant="outline" className="rounded-full px-8 py-6 text-base font-medium border-gray-300 hover:bg-gray-50 transition-transform hover:scale-105">
          ...
          <div className="grid grid-cols-3 gap-6 pt-12 mt-4 border-t border-gray-200">
            <div>
              <p className="text-3xl font-bold font-syne text-gray-900">2.4K+</p>
              <p className="text-xs text-gray-500 uppercase tracking-wider font-medium mt-1">Ideas Shared</p>
            </div>
            <div>
              <p className="text-3xl font-bold font-syne text-gray-900">15.0K+</p>
              <p className="text-xs text-gray-500 uppercase tracking-wider font-medium mt-1">Upvotes</p>
            </div>
            <div>
              <p className="text-3xl font-bold font-syne text-gray-900">340+</p>
              <p className="text-xs text-gray-500 uppercase tracking-wider font-medium mt-1">Projects Funded</p>
            </div>
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="px-4 py-3">
              ...
              <p className="text-gray-500 text-sm mt-2 line-clamp-2">
                A project focusing on building large-scale solar grids to support areas without access to safe and stable electricity.
              </p>
            </div>
            ...
            >
              ...
              <span className="text-xs font-bold text-gray-700 uppercase tracking-wider">Top Voted Idea 🚀</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
